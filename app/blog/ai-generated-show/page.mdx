...
export const metadata = {
  title: "How I made an AI-generated show - gigantino",
...
<Image src="/blog/ai-generated-show/ai_sponge.png" alt="ai_sponge" width={800} height={450} className="my-6 w-full rounded-lg border-3 border-[var(--color-black)] shadow-[4px_4px_0_var(--color-black)]" />
...
> **Update**: [CodeBullet](https://www.youtube.com/@CodeBullet) recently published a video called ["How I made AI Generated Rick and Morty Episodes"](https://www.youtube.com/watch?v=g39AagVW0s0). He makes excellent content, and the video is entertaining; if you are interested in the topic, I recommend you watch it as he took a bit of a different approach from us.
...
Thanks to a [YouTube video](https://www.youtube.com/_rGXIXyNqpk) published by [Fireship](https://www.youtube.com/c/Fireship) I also discovered [ElevenLabs](https://elevenlabs.io/).
...
> **Update**: Uberduck seems to have [deleted](https://www.uberduck.ai/post/new-voice-hosting-policy) most of their pre-trained models. If you plan to build something like this, I recommend against using it.
...
<Image src="/blog/ai-generated-show/moderation.png" alt="moderation example" width={800} height={450} className="my-6 w-full rounded-lg border-3 border-[var(--color-black)] shadow-[4px_4px_0_var(--color-black)]" />
...
<Image src="/blog/ai-generated-show/ai_rick_and_morty.png" alt="ai rick and morty" width={800} height={450} className="my-6 w-full rounded-lg border-3 border-[var(--color-black)] shadow-[4px_4px_0_var(--color-black)]" />
...
<Image src="/blog/ai-generated-show/gerrygpt.png" alt="gerrygpt" width={800} height={450} className="my-6 w-full rounded-lg border-3 border-[var(--color-black)] shadow-[4px_4px_0_var(--color-black)]" />
